...
def discount_and_normalize_rewards(all_rewards, discount_rate):
    ...
    return [(discounted_rewards - reward_mean)/reward_std for discounted_rewards in all_discounted_rewards] # normalization happens here
...
with tf.Session() as sess:
    ...
    for iteration in range(num_iterations):
        ...
        # multiply correct reward by the correct gradient
